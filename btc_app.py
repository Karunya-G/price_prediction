...
st.markdown('created by: **Team Bitcoin Investopedia**')
...
st.markdown("""<style>div.stButton > button:first-child {background-color: #d1eeea;color:#000000;}</style>""", unsafe_allow_html=True)
...
st.write('1. [yfinance](https://finance.yahoo.com/quote/BTC-USD/history/)')
